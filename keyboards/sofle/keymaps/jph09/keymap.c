...
[_NAV] = LAYOUT( \
  ...
  XXXXXXX, KC_LGUI,     KC_LALT,    KC_LCTL,       KC_LSFT,          KC_CAPS,                     KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, CW_TOGG, \
...
[_MOUSE] = LAYOUT( \
  ...
  XXXXXXX, KC_LGUI,     KC_LALT,    KC_LCTL,       KC_LSFT,          KC_CAPS,                     XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, XXXXXXX, \
...
[_MEDIA] = LAYOUT( \
  ...
  XXXXXXX, KC_LGUI,     KC_LALT,    KC_LCTL,       KC_LSFT,          KC_CAPS,                     KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, XXXXXXX, XXXXXXX, \
...
[_NUM] = LAYOUT( \
  ...
  KC_GRV,  KC_SCLN, KC_4, KC_5, KC_6, KC_EQL,                      KC_CAPS, KC_RSFT,          KC_RCTL,       KC_LALT,    KC_RGUI,     XXXXXXX, \
...
[_SYM] = LAYOUT( \
  ...
  S(KC_GRV), S(KC_SCLN), S(KC_4), S(KC_5), S(KC_6), S(KC_EQL),                      KC_CAPS, KC_RSFT,          KC_RCTL,       KC_LALT,    KC_RGUI,     XXXXXXX, \
...
[_FUN] = LAYOUT( \
  ...
  KC_CAPS, KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SCRL,                     KC_CAPS, KC_RSFT,          KC_RCTL,       KC_LALT,    KC_RGUI,     XXXXXXX, \
...
[_BUTTON] = LAYOUT( \
  ...
  XXXXXXX, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, KC_CAPS,                       KC_CAPS, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, XXXXXXX, \
